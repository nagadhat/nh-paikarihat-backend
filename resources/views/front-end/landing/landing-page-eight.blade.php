...
<head>
   ...
   {{-- /og meta --}}
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-eight.css') }}" />
    ...
    <title>Wireless Bracket Charger</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/chair-charger/header.png') }});">
            <div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="menubar_MenubarContent__rb5Uq" id="MenubarContent">
                                    <div class="menubar_Logo__xF9pv" id="Logo">
                                        <img src="{{ asset('front-end/assets/image/landing/landing-logo.png') }}" decoding="async"
                ...
                <div class="Landing__23__Reverce row mbl">
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">ইনডোর কিংবা আউটডোরে আপনার চার্জিংয়ের স্মার্ট সমাধান
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h5 class="text-white hide-on-mobile" style="font-size: 30px">15W Wireless Bracket Phone Charger</h5>
                            {{-- <h5 class="text-white hide-on-mobile" style="font-size: 30px">Induction Car Holder For Phone</h5> --}}
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/chair-charger/icon-1.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE">ওয়্যারলেস <br> চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/chair-charger/icon-2.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px">ডুয়েল এডজাস্টমেন্ট</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/chair-charger/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px;">
                                সেনসেটিভ <br> ইনডাকশন
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/chair-charger/icon-4.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px;">
                                বিল্ট ইন <br> স্মার্ট চিপ
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-1.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-1.png') }}"
                            alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-2.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-2.png') }}"
                            alt="">
                        <h4>ডুয়েল <br> এডজাস্টমেন্ট</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-3.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-3.png') }}"
                            alt="">
                        <h4> সেনসেটিভ <br> ইনডাকশন</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon"><img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/chair-charger/icon-4.png') }}" alt=""><img
                            class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/chair-charger/icon-4.png') }}"
                            alt="">
                        <h4>বিল্ট ইন <br> স্মার্ট চিপ</h4> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>15w ফাস্ট চার্জিং </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>ইনপুট DC 9V/1.67A or DC 5V/2A</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>আউটপুট DC 9V/1.1A or DC 5V/1A (Max)</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>চার্জিং পাওয়ার 110k-205khz;</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>প্রোডাক্ট ওয়েট 154.2g</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>কনভারসন এফিসিয়েন্সি  ≥80%</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>লার্জ কয়েল ইনডাকশন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>অটোমেটিক ট্রিকল মুড </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/chair-charger/dot.png') }}" alt="">
                                <h5>এডজাস্টেবল স্ট্যান্ড </h5>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/chair-charger/feature.png') }}" alt="" style="border-radius: 20px">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        width="100%" height="100%" {{-- src="https://www.youtube.com/embed/uFjU5zFJx3E?autoplay=1&amp;mute=0&amp;controls=1&amp;origin=https%3A%2F%2Fbdsgadget.com&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;iv_load_policy=3&amp;modestbranding=1&amp;enablejsapi=1&amp;widgetid=1" --}} {{-- src="https://www.youtube.com/embed/6-9dG2-LO7M?si=0elxcjpdqOwNk7xL" --}}
                                        src="https://www.youtube.com/embed/SSVhqIAezRE"
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Wireless Bracket Phone Charger</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            চার্জারটি স্বয়ংক্রিয়ভাবে আপনার  ডিভাইসকে  সনাক্ত করে এবং দ্রুত চার্জ করতে সহায়তা করে। 
                            ডিভাইসটি পিসি এবং এবিসি ম্যাটারিয়াল এর সমন্বয়ে ইউনিক চেয়ার শেইপে প্রস্তুত। 
                            আপনি আপনার ফোনটি ভার্টিক্যালি ও হরিজেন্টালি দুইভাবেই চার্জ করতে পারবেন।
                            এই গ্যাজটটি আউটডোর ভিজিট এবং অফিসে ব্যবহারের জন্য উপযোগী।
                            ডিভাইসটির লো টেম্পারেচার প্রটেকশন সিস্টেম তাপ অপচয় রোধ করে।
                        ...
                        <a class="bg3" href="#footer2">Call- 0190 6198502</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/chair-charger/main-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/chair-charger/main-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/chair-charger/main-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/chair-charger/ani.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            ভ্যালু এডেড সব ফিচারে সমৃদ্ধ এই স্মার্ট গ্যাজটটি আপনার লাইফে এনে দেবে  কমফোর্ট এবং স্মার্টনেস।
                            ইনডাকশন ডিস্টেন্স 0.8mm, চার্জিং ফেইজ type C, মেক্সিমাম আউটপুট পাওয়ার 5W থেকে 15w, হাই কোয়ালিটি চার্জিং সাপোর্ট স্ট্রেংথ।
                            আকর্ষণীয় এই ডিভাইসটি বাংলাদেশে এই ডিভাইসটি আমরা আপনাদেরকে দিচ্ছি অত্যন্ত সাশ্রয়ী মূল্যে৷
                        </p>
                ...
                <div class="row">
                    <div class="col">
                        <div class="footer4_FooterMainDiv__NDlXT">
                            ...
                            {{-- <div class="footer4_FooterMainDiv2__kY2jL">
                                <a href="#">
