    ...
    <div class="col-12" v-cloak>
        <div class="card">
            ...
            <div class="card-body">
                {{-- alert --}}
                <x-alert />
                <form action="{{ route('create_variation') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                    ...
                    <input type="hidden" value='1' id="total-variation">
                    <input type="hidden" value='0' id="variation-id">
                    <div v-for="number in loopcounter">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="form-label">Price<span
                                        ...
                                        :</label>
                                    <input type="number" name="price[]" placeholder="price" id="" value="0"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="color[]" id=""
                                        title="Choose variant color" style="height: 40px">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
