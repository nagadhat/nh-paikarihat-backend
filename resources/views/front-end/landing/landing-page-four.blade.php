...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-four.css') }}" />
    {{-- font-awesome --}}
    ...
    <title>Portable Charging Power Bank</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/powerbank/header-image.png') }});">
            <div class="container">
                    ...
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">
                                ট্যুর বা আউটডোর ভিজিটের সময় চার্জিংয়ের স্মার্ট সল্যুশন
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h6 class="text-white" style="font-size: 30px;">Portable Charging Power Bank!</h6>
                            {{-- <h6 class="text-white hide-on-mobile" style="font-size: 30px">Holder Wireless Car Charger</h6> --}}
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/powerbank/icon-1.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008C6B">ফাস্ট<br>চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/powerbank/icon-2.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008C6B">মাল্টি<br>কানেক্টর</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/powerbank/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008C6B; font-size: 19px;">
                                ভোল্টেজ<br>প্রটেকশন
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/powerbank/icon-4.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008C6B; font-size: 19px;">
                                ফ্ল্যাশলাইট <br> সিস্টেম
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/powerbank/icon-1.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/powerbank/icon-1.png') }}"
                            alt="">
                        <h4>ফাস্ট<br>চার্জিং</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/powerbank/icon-2.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/powerbank/icon-2.png') }}"
                            alt="">
                        <h4>মাল্টি<br>কানেক্টর</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/powerbank/icon-3.png') }}" alt="">
                        <img class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/powerbank/icon-3.png') }}" alt="">
                        <h4>ভোল্টেজ<br>প্রটেকশন</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/powerbank/icon-4.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/powerbank/icon-4.png') }}"
                            alt="">
                        <h4>ফ্ল্যাশলাইট <br> সিস্টেম</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>10000mAh এর শক্তিশালী ব্যাটারি </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>ডুয়েল ইনপুট এন্ড আউটপুট </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>২ টি ইউএসবি পোর্ট সমন্বিত</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>এক্সেসিভ পাওয়ার</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>আউটপুট ওভার ভোল্টেজ প্রটেকশন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>টেম্পারেচার রেজিস্ট্যান্স</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>ইনপুট ওভার ভোল্টেজ প্রটেকশন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>দীর্ঘস্থায়ী </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/powerbank/dot.png') }}" alt="">
                                <h5>বহন করা ও ব্যবহার করা অত্যন্ত সহজ</h5>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/powerbank/main.png') }}" alt=""
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        width="100%" height="100%" src="https://www.youtube.com/embed/tPHuZna7cjg"
                                        id="widget2">
                                    </iframe>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Portable 10000 mAh Powerbank</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            এই স্মার্ট  গ্যাজেট দিয়ে আপনি সহজেই  বিভিন্ন মডেলের  স্মার্টফোন, ডিজিটাল ক্যামেরা, পামটপ কম্পিউটার এবং ডিজিটাল ক্যামেরা চার্জ দিতে পারবেন।
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/powerbank/feature-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/powerbank/feature-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/powerbank/feature-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/powerbank/anima.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <p class="text-justify">
                            ...
                            স্মার্ট ডিজিটাল ডিসপ্লে, আল্ট্রা স্লিম USB, স্মার্ট কানেক্টিভিটি, ইনপুট ওভার ভোল্টেজ প্রটেকশন,0
    ...
    <div class="footer4_Footer4__OXjEB">
        ...
        $('#customer_username').change(function() {
            searchCustomer();
        });

        function searchCustomer() {
            let selectedCustomer = $('#selected_customer');
            let customerUsername = $('#customer_username');
            let csrfToken = $('#csrf_token');
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url: "landing-get-customer",
                data: {
                ...
                success: function(result) {
                    $('#selected_customer').val(result.first_name);
                    console.log(result);
                }
            });
        }
