...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-six.css') }}" />
    ...
    <title>Car Headrest Holder</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/headrest/header.png') }});">
            <div class="container">
                ...
                <div class="Landing__23__Reverce row mbl">
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">আপনার রোড ট্রিপকে আরও উপভোগ্য ও স্মুথ করে তুলবে
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h5 class="text-white hide-on-mobile" style="font-size: 30px"> 360 Rotation Car Headrest Tablet Mount Holder</h5>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/headrest/icon-1.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE">৩৬০ ডিগ্রি <br> রোটেশন</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/headrest/icon-2.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE">সহজ <br>ইন্সটলেশন</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/headrest/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                ...
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing//headrest/icon-4.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px;">স্ট্রং মেটাল
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/headrest/icon-1.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/headrest/icon-1.png') }}"
                            alt="">
                        <h4>৩৬০ ডিগ্রি <br> রোটেশন</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/headrest/icon-2.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/headrest/icon-2.png') }}"
                            alt="">
                        <h4>সহজ <br>ইন্সটলেশন</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/headrest/icon-3.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/headrest/icon-3.png') }}"
                            alt="">
                        <h4>শক্তিশালী <br>গ্রিপ</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon"><img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/headrest/icon-4.png') }}" alt=""><img
                            class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/headrest/icon-4.png') }}"
                            alt="">
                        <h4>স্ট্রং <br>মেটাল </h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            ...
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>দ্বিগুণ মেগনেটিক ক্ষমতাসম্পন্ন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>ট্রায়াঙ্গুলার স্ট্রাকচার সাপোর্ট</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>ফ্রন্ট এন্ড রিয়ার এডজাস্টমেন্ট</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>ইজি সেট ডিসপ্লে 4.7" to 13"</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>কমফোর্টেবল ভিউ</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>৫ কেজি ধারণ ক্ষমতাসম্পন্ন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/headrest/feature.png') }}" alt="" style="border-radius: 20px">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        src="https://www.youtube.com/embed/jikwdxYMUto"
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Car Headrest Holder!</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            আপনার রোড ট্রিপ বা কার ড্রাইভিংকে আনন্দমুখর ও ফুলফিলিং করে তুলতে এই ডিভাইসটি হতে পারে এক অসাধারণ সঙ্গী।
                            শক্তিশালী রেয়ার-আর্থ নিওডিমিয়াম ম্যাগনেটে তৈরি এই স্মার্ট গ্যাজেটটি আপনার ডিভাইসের সিকিউর গ্রিপ পাওয়া নিশ্চিত করে।
                            ৩৬০ ডিগ্রি রোটেশন এডজাস্টমেন্ট সুবিধা সম্বলিত। খারাপ রাস্তায় যাতায়াতের সময় অথবা হঠাৎ করে গাড়ি ব্রেক করলেও
                            এই ডিভাইসটি ক্ষতিগ্রস্ত হবে না।
                        </p>
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/headrest/main-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/headrest/main-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/headrest/main-5.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/headrest/ani.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            ভ্যালু এডেড সব ফিচারে সমৃদ্ধ এই স্মার্ট ডিভাইসটি আপনার লাইফে এনে দেবে  কমফোর্ট এবং স্পিড,
                            ইজি মাউন্টিংয়ের জন্য এতে থাকছে প্রটেকটিভ ফিল্ড। চমৎকার মেটাল ফিনিশ মাউন্টকে দিয়েছে একটি চার্মিং ও রিফাইন্ড লুক
