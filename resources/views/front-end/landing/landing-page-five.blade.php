...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-five.css') }}" />
    {{-- font-awesome --}}
    ...
    <title>Wireless Phone Charger</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/magnetic/header-image.png') }});">
            <div class="container">
                ...
                <div class="Landing__23__Reverce row mbl">
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">আউটডোর ভিজিট বা লোডশেডিংয়ে চার্জিংয়ের স্মার্ট সমাধান
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h5 class="text-white hide-on-mobile" style="font-size: 30px">Magnetic Wireless Charging Power Bank</h5>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/magnetic/icon-2.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE">ক্যাবল-ফ্রি <br> চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/magnetic/icon-1.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE">ম্যাগনেটিক <br> চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/magnetic/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px;">
                                ডুয়েল চার্জিং <br> মুড
                            </h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing//magnetic/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#0069AE; font-size: 19px;">ইন্টেলিজেন্ট <br> সেইফটি 
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/magnetic/icon-2.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/magnetic/icon-2.png') }}"
                            alt="">
                        <h4>ক্যাবল-ফ্রি <br> চার্জিং</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/magnetic/icon-1.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/magnetic/icon-1.png') }}"
                            alt="">
                        <h4>ম্যাগনেটিক <br> চার্জিং</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/magnetic/icon-3.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/magnetic/icon-3.png') }}"
                            alt="">
                        <h4>ডুয়েল চার্জিং <br> মুড</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon"><img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/magnetic/icon-4.png') }}" alt=""><img
                            class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/magnetic/icon-4.png') }}"
                            alt="">
                        <h4>ইন্টেলিজেন্ট <br> সেইফটি </h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>চার্জিং কেপাসিটি 10000mAh/3.7V (37Wh)</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>পলিমার ব্যাটারী</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>USB আউটপুট 12V/1.5A 18W</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>Type-C ইনপুট 9V/2A 18W</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>Type-C আউটপুট  12V/1.5A 20W</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>এনার্জি কনভার্সন রেট ≥75%</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>ম্যাগনেটিক এটাচমেন্ট</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                                <h5>সেইফটি প্রটেকশন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/magnetic/dot.png') }}" alt="">
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/magnetic/feature.png') }}" alt="" style="border-radius: 20px">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        src="https://www.youtube.com/embed/Tw3JbfTve1Y"
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Magnetic Wireless Power Bank</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            10000mAh ম্যাগসেফ পোর্টেবল চার্জারটি অত্যন্ত কমপ্যাক্ট এবং লাইটওয়েট।
                            আপনার ব্যাগ বা এমনকি আপনার পকেটে অনায়াসে ফিট করে, আপনি যেতে যেতে আপনার ডিভাইসটি চার্জ করতে পারবেন।
                            এই গ্যাজেটের আরেকটি ইউনিক ফিচার হচ্ছে এর সাহায্যে আপনি ক্যাবলের সাহায্যে এবং ক্যাবল ছাড়া দুইভাবেই আপনার স্মার্টফোনটি চার্জ দিতে পারবেন।
                            ফাস্ট চার্জিং ইন্টেলিজেন্ট চিপ সমন্বিত এই ইউনিক গ্যাজেটটি হতে পারে আপনার লাইফের স্মার্ট সঙ্গী।
                        </p>
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/magnetic/feature-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/magnetic/feature-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/magnetic/feature-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/magnetic/ani.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <p class="text-justify">
                            ...
                            স্মার্ট ডিজিটাল ডিসপ্লে, ডুয়েল চার্জিং সিস্টেম, এই ডিভাইসটির সাহায্যে সেলফোন, ডিজিটাল ক্যামেরা, চার্জ দেয়া সম্ভব,
                            সহজে বহন যোগ্য, একবার চার্জ দিয়ে দীর্ঘ সময় পর্যন্ত ব্যবহার করা যায়৷
