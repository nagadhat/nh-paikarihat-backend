...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-two.css') }}" />
    {{-- font-awesome --}}
    ...
    <title>Light Wireless Charger</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/light-lamp/header-image.png') }});">
            <div class="">
            </div>
            <div class="container">
                    ...
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">
                                স্মার্ট লাইফস্টাইলের সঙ্গী হোক স্মার্ট ডিভাইস
                                <br>Smart G-Lamp
                            </h1>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/light-lamp/charger.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#9049AF">ওয়্যারলেস<br>চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/light-lamp/light.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#9049AF">স্মার্ট LED<br>লাইট </h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/light-lamp/blutooth.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#9049AF; font-size: 19px;">
                                ব্লুটুথ <br> স্পিকার
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/light-lamp/alerm.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#9049AF; font-size: 19px;">
                                অ্যালার্ম<br>ক্লক
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/light-lamp/charger.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/light-lamp/charger.png') }}"
                            alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/light-lamp/light.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/light-lamp/light.png') }}"
                            alt="">
                        <h4>স্মার্ট LED<br>লাইট</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/light-lamp/blutooth.png') }}" alt="">
                        <img class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/light-lamp/blutooth.png') }}" alt="">
                        <h4>ব্লুটুথ<br>স্পিকার </h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/light-lamp/alerm.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/light-lamp/alerm.png') }}"
                            alt="">
                        <h4>অ্যালার্ম<br>ক্লক</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>বিল্ট ইন ফাস্ট চার্জিং প্রটোকল</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>বিল্ট ইন হাই কোয়ালিটি স্পিকার</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>শক্তিশালী বিল্ট ইন ব্যাটারি </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>ব্রাইটনেস এডজাস্টমেন্ট</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>এটমোস্ফিয়ার লাইট</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                                <h5>ইনহেন্সড অডিও এক্সপেরিয়েন্স</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/light-lamp/icon.png') }}" alt="">
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/light-lamp/special.png') }}" alt=""
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        width="100%" height="100%" src="https://www.youtube.com/embed/1dOT02WAH6A"
                                        id="widget2">
                                    </iframe>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Wireless Charging Smart G-Lamp</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            এই ডিভাইসের উপর স্মার্টফোনটি রেখে কোন ক্যাবলের সাহায্য ছাড়াই দ্রুত আপনার স্মার্টফোনটি চার্জ
                            করতে পারবেন।
                            ডিভাইসে থাকা স্মার্ট LED লাইট দিনের বিভিন্ন সময় বিভিন্ন মুডে আলো দেবে যা আপনার মনকে প্রফুল্ল
                            রাখতে সহায়তা করবে।
                            ডিভাইসের সাথে সংযুক্ত ব্লুটুথ স্পিকার দিয়ে আপনি পছন্দের মিউজিক উপভোগ করতে পারবেন এবং কল
                            রিসিভ করতে পারবেন।
                            এছাড়া এই ডিভাইসের এলার্ম ক্লক আপনাকে জেগে উঠতে বা রিমাইন্ডার দিতে সাহায্য করবে।
                        </p>
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/light-lamp/main-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/light-lamp/main-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/light-lamp/main-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/light-lamp/anima.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <p class="text-justify">
                            ...
                            স্মার্ট লাইট কন্ট্রোল, স্মার্ট কানেক্টিভিটি, নির্ভরযোগ্যতা,
                            একবার চার্জ দিয়ে দীর্ঘ সময় পর্যন্ত ব্যবহার করা যায়,
                            ন্যাচারাল স্লিপ এইড সাউন্ড মেশিন, সহজে বহন যোগ্য, দীর্ঘ সময় ধরে ব্যবহার উপযোগী৷
