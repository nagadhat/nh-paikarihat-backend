...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page.css') }}" />
    {{-- font-awesome --}}
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/landing-background.png') }});">
            {{-- <div class="">
                <x-simple-alert />
            </div> --}}
            <div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="menubar_MenubarContent__rb5Uq" id="MenubarContent">
                                    <div class="menubar_Logo__xF9pv" id="Logo">
                                        <img src="{{ asset('front-end/assets/image/landing/ph-logo.png') }}"
                ...
                <div class="Landing__23__Reverce row mbl">
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">স্মার্ট কার ওয়্যারলেস চার্জার ফোন হোল্ডার
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h5 class="text-white hide-on-mobile" style="font-size: 30px">Fast Charging সুপার পাওয়ারফুল
                                Wireless
                                Phone Induction Car Holder For Phone</h5>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/small-icon.png') }}"
                            class="card-img-top mx-auto" alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#BE1E2D">সুপার <br> ফাস্ট চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/small-icon2.png') }}"
                            class="card-img-top mx-auto" alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#BE1E2D">সহজ <br>ইন্সটলেশন</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/small-icon3.png') }}"
                            class="card-img-top mx-auto" alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#BE1E2D; font-size: 19px;">রোটেশন
                                <br>এডজাস্টমেন্ট
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/small-icon4.png') }}"
                            class="card-img-top mx-auto" alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#BE1E2D; font-size: 19px;">ইনফ্রারেড<br>সেন্সর
                            </h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/small-icon.png') }}" alt="">
                        <img class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/small-icon.png') }}" alt="">
                        <h4>সুপার <br> ফাস্ট চার্জিং</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/small-icon2.png') }}" alt="">
                        <img class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/small-icon2.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/small-icon3.png') }}" alt="">
                        <img class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/small-icon3.png') }}" alt="">
                        <h4>রোটেশন <br>এডজাস্টমেন্ট</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon"><img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/small-icon4.png') }}" alt=""><img
                            class="Landing__23__ShipImg1"
                            src="{{ asset('front-end/assets/image/landing/small-icon4.png') }}" alt="">
                        <h4>ইনফ্রারেড<br>সেন্সর</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>ফোর কোর টেকনোলজি বিশিষ্ট </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>আলট্রা ক্যাপাসিটর </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5> রিয়ার টাচ সেন্সিং</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>কয়েল ইনডাকশন </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>অটমেটিক এবং ফাস্ট লকিং</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>শক্তিশালী বিল্ট ইন ব্যাটারি </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>আলট্রা থিন এবং সহজে বহনযোগ্য</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>সেইফটি প্রটেকশন</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/dot.png') }}" alt="">
                                <h5>ট্রান্সপারেন্ট</h5>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/f-m.png') }}" alt=""
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        src="https://www.youtube.com/embed/QlpZyr8uFhI?si=SRVPBgGaD8HF_LES"
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>ফোন চার্জার ওয়্যারলেস কার হোল্ডার</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            ওয়াইড রেঞ্জের মডেলের মোবাইল সেট এবং গাড়িতে ব্যবহার উপযোগী। গাড়ির উইন্ডশিল্ড বা ড্যাশবোর্ডে
                            স্মার্টলি প্লেস করা যায়।
                            ৩৬০ ডিগ্রি রোটেশন এডজাস্টমেন্ট সুবিধা সম্বলিত। খারাপ রাস্তায় যাতায়াতের সময় অথবা হঠাৎ করে
                            গাড়ি ব্রেক করলেও
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/feature-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/feature-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/feature-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/img8.png') }}"
                                            alt="img">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide swiper-slide-active Landing__23__SliderImg"
                                ...
                                <a href="#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/ani.gif') }}"
                                            alt="img" style="border-radius: 15px">
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <p class="text-justify">
                            ...
                            ইউনিক ডিজাইন, সিলিকন ইনার প্যাড, নির্ভরযোগ্যতা,
                            একবার চার্জ দিয়ে দীর্ঘ সময় পর্যন্ত ব্যবহার করা যায়,
                            ইন্টেলিজেন্ট ওপেনিং এন্ড ক্লোজিং, সহজে বহন যোগ্য, দীর্ঘ সময় ধরে ব্যবহার উপযোগী৷
