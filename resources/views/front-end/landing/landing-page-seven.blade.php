...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/landing-page-seven.css') }}" />
    ...
    <title>Water Bottle Travel Flask</title>
    <!-- Favicon -->
...
<body>
    <section>
        <div class="Landing__23__bg_div backimg imgmobile"
            style="background-image: url({{ asset('front-end/assets/image/landing/bottle/header.png') }});">
            <div class="container">
                ...
                <div class="Landing__23__Reverce row mbl">
                    <div class="col-md-6  py-5">
                        <div class="Landing__23__BannerTxt">
                            <h1 class="fw-bold title">আপনার ভ্রমণকে আনন্দদায়ক ও  উপভোগ্য করে তুলতে সঙ্গে রাখুন ভ্যাকুয়াম ফ্লাস্ক
                            </h1>
                            <div class="Landing__23__HrBanner  hide-on-mobile"></div>
                            <h5 class="text-white hide-on-mobile" style="font-size: 30px">Water Bottle Travel Mugs Vacuum Flask</h5>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/bottle/icon-1.png') }}" class="card-img-top mx-auto"
                            alt="Card Image">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008080">নো <br> চার্জিং</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/bottle/icon-2.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008080">স্টেইলনেস <br> স্টিল</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing/bottle/icon-3.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008080; font-size: 19px;">
                                টেম্পারেচার <br> সেনসেটিভ
                            </h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 mt-3">
                    <div class="card text-center" style="width: 10rem;">
                        <img src="{{ asset('front-end/assets/image/landing//bottle/icon-4.png') }}" class="card-img-top mx-auto"
                            alt="Card Image" style="width: 40%">
                        <div class="card-body">
                            <h5 class="card-text fw-bold" style="color:#008080; font-size: 19px;">
                                ডিজিটাল <br> ডিসপ্লে
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/bottle/icon-1.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/bottle/icon-1.png') }}"
                            alt="">
                        <h4>নো <br> চার্জিং</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/bottle/icon-2.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/bottle/icon-2.png') }}"
                            alt="">
                        <h4>স্টেইলনেস <br> স্টিল</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon">
                        <img class="Landing__23__ShipImg2" src="{{ asset('front-end/assets/image/landing/bottle/icon-3.png') }}"
                            alt="">
                        <img class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/bottle/icon-3.png') }}"
                            alt="">
                        <h4>টেম্পারেচার <br> সেনসেটিভ</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="Landing__23__ShippingIcon"><img class="Landing__23__ShipImg2"
                            src="{{ asset('front-end/assets/image/landing/bottle/icon-4.png') }}" alt=""><img
                            class="Landing__23__ShipImg1" src="{{ asset('front-end/assets/image/landing/bottle/icon-4.png') }}"
                            alt="">
                        <h4>ডিজিটাল <br> ডিসপ্লে</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="Landing__23__Features">
                        ...
                        <ul>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>৫০০ মি.লি. ধারণক্ষমতা</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>প্রোডাক্ট সাইজ  225x65mm</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>304 ফিল্টার</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>রাউন্ড স্পাইরাল বটল মাউথ</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>স্মার্ট ইনসুলেটেড মগ</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>ফুড গ্রেড সিলিকনে তৈরি </h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>ইলেক্ট্রো পলিশড</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>উন্নত প্রযুক্তিতে তৈরি থার্মস ভ্যাকুয়াম ফ্লাস্ক</h5>
                            </li>
                            <li> <img src="{{ asset('front-end/assets/image/landing/bottle/dot.png') }}" alt="">
                                <h5>প্লাস্টিক বোতল এবং কাপের নিরাপদ বিকল্প</h5>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="Landing__23__FeaturesImgDiv">
                        <img src="{{ asset('front-end/assets/image/landing/bottle/feature.png') }}" alt="" style="border-radius: 20px">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div style="width: 640px; height: 360px;">
                                <div style="width: 100%; height: 100%;">
                                    <iframe frameborder="0" allowfullscreen=""
                                        ...
                                        src="https://www.youtube.com/embed/pPtw6RDZJZA"
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        <h4>Water Bottle Travel Mugs</h4>
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            আপনার ভ্রমণকে আনন্দদায়ক ও  উপভোগ্য করে তুলতে সঙ্গে রাখুন ভ্যাকুয়াম ফ্লাস্ক। 
                            এই গ্যাজটটি আউটডোর ভিজিট,  সাইক্লিং, ক্যাম্পিংয়ে এবং অফিসে ব্যবহারের জন্য একদম আদর্শ।
                            চা , কফি, দুধ, জুস  বা পানি দীর্ঘসময়  গরম বা ঠাণ্ডা  রাখতে নিশ্চিন্তে ব্যবহার করুন উন্নত প্রযুক্তিতে তৈরি স্টেইলনেস স্টিলের
                            স্বাস্থ্যসম্মত ভ্যাকুয়াম ফ্লাস্ক। পরিবার ও প্রিয়জনদের জন্য এই স্মার্ট গ্যাজেটটি আপনি উপহার হিসেবে দিতে পারবেন।
                        </p>
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/bottle/main-1.png') }}" alt="img"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/bottle/main-2.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate Landing__23__SliderImg swiper-slide-next"
                        ...
                        <a href="/p/fast-wzarles-kar-carjar#">
                            <div class="Landing__23__Slider_CardDiv">
                                <img class="Landing__23__Slider_CardDivImg"
                                    src="{{ asset('front-end/assets/image/landing/bottle/main-3.png') }}" alt="img"
                                    style="border-radius: 15px">
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                        ...
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active Landing__23__SliderImg"
                                ...
                                <a href="/p/fast-wzarles-kar-carjar#">
                                    <div class="Landing__23__Slider_CardDiv">
                                        <img class="Landing__23__Slider_CardDivImg"
                                            src="{{ asset('front-end/assets/image/landing/bottle/ani.gif') }}" alt="img">
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="Landing__23__VideoTxtDiv Landing__23__Features">
                        ...
                        <div class="Landing__23__Hr2"></div>
                        <p class="text-justify">
                            ভ্যালু এডেড সব ফিচারে সমৃদ্ধ এই স্মার্ট গ্যাজটটি আপনার লাইফে এনে দেবে  কমফোর্ট এবং স্পিড।
                            ৬ থেকে ১২ ঘন্টা থার্মাল ইনসুলেশন নিশ্চিত করে। 
                            খুব সহজেই পরিস্কার ও বহন করা যায়।
                            হাই কোয়ালিটি সম্পন্ন এই স্মার্ট গ্যাজেটটি এনভায়রনমেন্টাল প্রটেকশনের নিশ্চয়তা দেয়। 
